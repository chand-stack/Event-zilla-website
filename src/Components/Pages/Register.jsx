        ...
        <div className=" flex-col ">
          <div className="my-2 ">
            <h1 className="text-5xl text-center font-bold text-pink-500">
              <span className="text-black">Register</span> now!
            </h1>
          </div>
          <div className="card flex-shrink-0 w-full  bg-base-100">
            <form onSubmit={registerHandler} className="card-body">
              ...
              <div className="form-control">
                ...
                />
                <label className="label">
                  <p className="label-text-alt link link-hover font-bold">
                    Forgot password?
                  </p>
                </label>
              </div>
              <div className="form-control mt-6">
                <button
                  type="submit"
                  className="btn btn-primary bg-black text-pink-500 font-bold border-none"
                >
                  Create an account
                </button>
              </div>
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="btn btn-outline font-extrabold flex justify-center"
                >
