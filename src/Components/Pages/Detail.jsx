    ...
    <>
      ...
      <div className="flex flex-col-reverse md:flex-col">
        <img
          ...
          className="md:h-[400px] mx-auto my-3"
          src={detail.image}
          alt=""
        />
        <div
          ...
          className="space-y-3 px-1 md:px-5"
        >
          <p className="flex items-center gap-3 text-xl text-pink-500 font-bold justify-center">
            The Services We Will Provide <BsFileArrowDownFill />
          </p>
          <p className="font-semibold flex items-center gap-2">
            <TiTick className="text-pink-500 text-2xl" />
            {detail.service_1}
          </p>
          <p className="font-semibold flex items-center gap-2">
            <TiTick className="text-pink-500 text-2xl" />
