        ...
        >
          <div className="h-52 md:h-[85vh] bg-black bg-opacity-80 w-full">
            <div
              ...
              className="flex justify-center mt-10 md:mt-16 lg:mt-10"
            >
              <p className="text-3xl md:text-7xl lg:text-9xl font-bold text-white">
                <span>
                  <HiGift className="text-pink-500" />
                </span>{" "}
                We Plan The <br /> Best{" "}
          ...
          <div className="h-52 md:h-[85vh] bg-black bg-opacity-80 w-full flex justify-center items-center">
            ...
            >
              <h1 className="text-3xl md:text-7xl font-bold text-white">
                Plan your perfect <span className="text-pink-500">Event</span>,{" "}
                <br /> every time
              </h1>
              <h1 className="text-3xl md:text-7xl font-bold text-white">
                We make your <span className="text-pink-500">Events</span>{" "}
                memorable
              </h1>
            </div>
          </div>
